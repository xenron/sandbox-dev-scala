...
package scopeA {
  ...
  class ProtectedClass3 {
    ...
    val protectedField1 = protectedClass1.protectedField1 // FEHLER
    val protectedField2 = protectedClass1.protectedField2 // FEHLER
    val protectedNField = protectedClass1.nested.nestedField // FEHLER
  }
...
package scopeB {
  class ProtectedClass4B extends scopeA.ProtectedClass4 // FEHLER
}