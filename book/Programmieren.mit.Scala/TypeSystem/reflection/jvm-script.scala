...
val c = new C
val clazz = c.getClass              // Methode aus java.lang.Object
val clazz2 = classOf[C]             // Scala-Methode: classOf[C] ~ C.class
val methods = clazz.getMethods      // Methode aus java.lang.Class<T>
